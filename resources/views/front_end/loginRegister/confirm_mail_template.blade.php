...
<head>
    <title>Please confirm your password request!</title>
    <!--[if !mso]><!-- -->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                            <tr>
                                                <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                    <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 1px; font-weight: 400; line-height: 0; text-align: center; color: #F2F2F2;">Please confirm your new account registration request!</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                            ...
                                            <tr>
                                                <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;width: 160px;" width="160"> <a href="{{$url}}" target="_blank" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; padding: 0 10px;"> <img alt="{{$app_name}}" height="auto" src="{{asset('/').$logo}}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"> </a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; text-align: right; font-size: 0px; word-break: break-word;">
                                                    <div class="inline-links" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                        ...
                                                        <![endif]--> <a class="link" href="{{$url.'customer/account-dashboard'}}" target="_blank" style="display: inline-block; color: #808080; font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 13px; font-weight: bold; line-height: 22px; text-decoration: none; text-transform: none; padding: 0 10px;"> My Account </a> <!--[if mso | IE]>
                                                        </td>
                                                        </tr>
                                                        </table>
                                                        <![endif]-->
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                                        <tr>
                                                            <td align="left" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 26px; font-weight: bold; line-height: 30px; text-align: left; color: #4F4F4F;">Please confirm your {{$app_name}} account registration request!</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;"><br>
                                                                    ...
                                                                    Someone tried to sign up for an {{$app_name}} account
                                                                    with {{$email}}. If it was you, click the confirm button below in the app: <br><br></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" vertical-align="middle" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                                    <tr>
                                                                        <td align="center" bgcolor="#dd2c00" role="presentation" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; border: none; border-radius: 3px; cursor: auto; mso-padding-alt: 10px 25px; background: #dd2c00;" valign="middle"> <a href="{{$link}}" style="display: inline-block; background: #dd2c00; color: #ffffff; font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 120%; margin: 0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank">Confirm register account</a> </td>
                           Fhi                                         </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;"><br> If you have any questions, please, <a target='_blank' style='font-weight: bold;color: #2E9CC3;' href="{{$url.$app_name.'-contacts-us'}}">Contact Us</a>! <br></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                    <div style="font-family:OpenSans, Helvetica, Tahoma, Arial, sans-serif;font-size:12px;font-weight:400;line-height:20px;text-align:center;color:#4F4F4F;">
                                                        <div>
                                                            <a href="{{$url}}" target="_blank" style="color: #333333; line-height: 20px; text-decoration: underline;">Home</a> |
{{--                                                            <a href="https://demo2.vamshop.com/account_history.php" style="color: #333333; line-height: 20px; text-decoration: underline;">My Orders</a> |--}}
{{--                                                            <a href="https://demo2.vamshop.com/specials.php" target="_blank" style="color: #333333; line-height: 20px; text-decoration: underline;">Specials</a> |--}}
{{--                                                            <a href="https://demo2.vamshop.com/manufacturers.php" style="color: #333333; line-height: 20px; text-decoration: underline;">Brands</a> |--}}
{{--                                                            <a href="https://demo2.vamshop.com/products_new.php" target="_blank" style="color: #333333; line-height: 20px; text-decoration: underline;">New Products</a>--}}
                                                        </div>
                                                        <br /> &copy; {{$date}} {{$app_name}}
                                                        <br />
                                                    </div>
                                                </td>
                                            </tr>
