                ...
                <div class="container">
                    <div class="breadcrumb-content text-center">
                        ...
                        <ul>
                            ...
                            <li class="active">New password set</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div id="lg1" class="tab-pane active">
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        ...
                                        @endif
                                        {{Form::open(['method'=>'post','id'=>'customerReset_form','route'=>'customer_new_password_set_save'])}}
                                        <input type="hidden" name="email" required value="{{$email}}">
                                        <input type="password" name="new_password"  required autocomplete="off" placeholder="New password">
                                        <input type="password" name="confirm_password" required autocomplete="off" placeholder="Confirm password">
                                        <div class="button-box">

                                            <div class="button-box">
                                                <button type="submit" class="g-recaptcha pull-right"  data-sitekey="{{env('recaptcha_site_key')}}"
                                                        data-callback='onReset'
                                                        data-action='submit'>Save password</button>
                                            </div>
