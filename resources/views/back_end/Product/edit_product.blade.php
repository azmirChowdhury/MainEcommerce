                    ...
                    <div class="col-lg-8">
                        <div class="card m-b-20">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                {{Form::open(['method'=>'post','enctype'=>'multipart/form-data','route'=>'save_edit_product'])}}
                                <input type="hidden" name="id" value="{{$product->id}}">
                                <h4 class="mt-0 header-title">Edit product</h4>
                                <div class="form-group">
                                    <label>Product name <sup class="text-danger"> *</sup></label>
                                    <input type="text" name="product_name"
                                           value="{{old('product_name')==true?old('product_name'):$product->product_name}}"
                                           autocomplete="off" class="form-control" required placeholder="Product Name"/>
                                </div>

                                <div class="form-group">
                                    <label>Product Specification</label>
                                    <textarea id="editor"
                                              name="product_specification">{{old('product_specification')==true?old('product_specification'):$product->product_specification}}</textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <h6 class="m-0 font-14">
                                        <a href="#collapseOne" class="text-dark" data-toggle="collapse"
                                           ...
                                           aria-controls="collapseOne">
                                            Currency <sup class="text-danger"> *</sup> <i
                                                class="fa fa-angle-up float-lg-right"></i>
                                        </a>
                                    </h6>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <select required name="currency" class="form-control">
                                                <option value="bt" {{$product->currency=='bt'?'selected':''}} >BDT
                                                </option>
                                                <option value="ud" {{$product->currency=='ud'?'selected':''}}>USD
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div id="collapseOne" class="collapse show"
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#Attribute"
                                        ...
                                        <div class="tab-pane active p-3" id="General" role="tabpanel">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="sale_price" required
                                                       value="{{old('sale_price')==true?old('sale_price'):$product->sale_price}}"
                                        ...
                                        <div class="tab-pane p-3" id="Inventory" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" name="product_quantity"
                                                       value="{{old('product_quantity')==true?old('product_quantity'):$product->product_quantity}}"
                                                       class="form-control">
                                            </div>
                                        ...
                                        <div class="tab-pane p-3" id="Shipping" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="product_weight"
                                                       value="{{old('product_weight')==true?old('product_weight'):$product->product_weight}}"
                                                       class="form-control">
                                            </div>
                                            <label>Dimension (cm)</label>
                                            <div class="form-group">
                                                <input type="text" name="product_length"
                                                       value="{{old('product_length')==true?old('product_length'):$product->product_length}}"
                                                       placeholder="Length" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="product_width"
                                                       value="{{old('product_width')==true?old('product_width'):$product->product_width}}"
                                                       placeholder="Width" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="product_height"
                                                       value="{{old('product_height')==true?old('product_height'):$product->product_height}}"
                                        ...
                                        <div class="tab-pane p-3" id="Attribute" role="tabpanel">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="size[]" class="select2 form-control select2-multiple"
                                                        multiple data-placeholder="Choose size ...">
                                                    @if(!$product['size_product']==null)

                                                        @foreach($product['size'] as $size)
                                                            @if(in_array($size->Size,$product['size_product'])==true)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="color[]" class="select2 form-control select2-multiple"
                                                        multiple data-placeholder="Choose color ...">

                                                    @if(!$product['color_product']==null)

                                                        @foreach($product['color'] as $color)
                                                            @if(in_array($color->color_name,$product['color_product'])==true)
                                                                <option value="{{$color->color_name}}"
                                                                        selected>{{$color->color_name}}</option>
                                                            @else
                                                                <option
                        ...
                        <div class="card m-b-20 m-t-20">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="product_image" class="filestyle"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="elm1"
                                              name="long_description">{{old('long_description')==true?old('long_description'):$product->long_description}}</textarea>
                                </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#all_categories" role="tab">All
                                            Categories</a>
                                    </li>
                                    ...
                                    <div>
                                        <select name="brand_name" class="form-control select2">
                                            @foreach($product['brands'] as $brand)
                                                @if($product->brand_name==$brand->brand_name)
                                                    <option value="{{$brand->brand_name}}"
                                                            selected>{{$brand->brand_name}}</option>
                                                @else
                                                    <option
                                                        value="{{$brand->brand_name}}">{{$brand->brand_name}}</option>
                                                @endif
                                            @endforeach
                                            @if($product->brand_name!=$brand->brand_name)
                                                <option value="{{$product->brand_name}}"
                                                        selected>{{$product->brand_name}}</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="product_gallery_images[]" class="filestyle"
                                               data-input="false" data-buttonname="btn-secondary" multiple>
                                    </div>
                                    @if(! $product['image_product']==null)
                                        @foreach($product['image_product'] as $images)
                                            <img src="{{asset('/').$images}}" width="80" height="80">
                                        @endforeach
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="form-group m-b-0 d-flex ">
                                            <a href="{{url('/dashboard')}}" type="reset"
