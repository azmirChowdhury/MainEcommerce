                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Add color</h4>

                                {{Form::open(['method'=>'POST','route'=>'color_save'])}}

                                    <label class="text-muted">Color name</label>

                                    <input type="text" class="form-control" maxlength="40" value="{{old('color_name')}}" name="color_name"
                                           id="defaultconfig"/>
                                    ...
                                    <div class="color-picker-inputs">
                                        <div class="form-group">
                                            ...
                                            <div id="colorpicker-color-pattern" data-format="alias" class="input-group colorpicker-component">
                                                <input type="text" class="form-control" name="color" value="{{old('color')}}" placeholder="Select color or enter color code with #"/>
