                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Manage Campaign</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Manage campaign</h4>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="{{route('add_campaign')}}">Run new campaign</a>
                                </div>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    @foreach($campaigns as $campaign)
                                        <div class="modal fade" id="exampleModalCenter{{$campaign->id}}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{route('delete_campaign',['id'=>$campaign->id])}}" class="btn btn-danger">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
