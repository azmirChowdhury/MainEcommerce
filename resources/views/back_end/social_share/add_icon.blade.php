            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Add new social link</h4>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-8">
                        <div class="card m-b-20">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                {{Form::open(['method'=>'post','route'=>'save_link'])}}

                                <h4 class="mt-0 header-title">Social new link add</h4>

                                    <div class="form-group">
                                        <label>Platform name</label>
                                        <input type="text" name="platform_name" value="{{old('platform_name')}}" class="form-control" placeholder="Social media name">
                                    </div>

                                <div class="form-group">
                                    <label>URL/Link</label>
                                    <textarea class="form-control" name="url" placeholder="https://www.facebook.com">{{old('url')}}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                   ...
                                   <input type="text" maxlength="30" name="icon_class" value="{{old('icon_class')}}" class="form-control" placeholder="icon class name example:  ion-social-facebook">
                                </div>
