                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Parents Category</li>
                        </ol>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="card m-b-20">
                            <div class="card-body">
                               ...
                               @endif
                                <h4 class="mt-0 header-title">Add Parents Category</h4>

                                {{Form::open(['method'=>'POST','enctype'=>'multipart/form-data','route'=>'save_parents_category'])}}

                                <label class="text-muted">Parents Category Name</label>

                                <input type="text" class="form-control" maxlength="40" value="{{old('category_name')}}" name="category_name"
                                       id="defaultconfig"/>
                                <div class="m-t-20">
