                                            ...
                                            <tr>
                                                <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;width: 160px;" width="160"> <a href="{{$url}}" target="_blank" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; padding: 0 10px;"> <img alt="{{$app_name}}" height="auto" src="{{$url}}back_end/images/logo_and_background/446_Logo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"> </a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; text-align: right; font-size: 0px; word-break: break-word;">
                                                    <div class="inline-links" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                        ...
                                                        <![endif]--> <a class="link" href="{{$url}}" target="_blank" style="display: inline-block; color: #808080; font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 13px; font-weight: bold; line-height: 22px; text-decoration: none; text-transform: none; padding: 0 10px;"> My Account </a> <!--[if mso | IE]>
                                                        </td>
                                                        </tr>
                                                        </table>
                                                        <![endif]-->
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                                        <tr>
                                                            <td align="left" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 26px; font-weight: bold; line-height: 30px; text-align: left; color: #4F4F4F;">Please confirm your password request!</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;"><br>
                                                                    ...
                                                                    If you confirm the link, by clicking it, immediately reset password opportunity
                                                                    is sent to you . <br><br></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
{{--                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">--}}
{{--                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 300; line-height: 25px; text-align: left; color: #4F4F4F;">Confirm Your New Password: <strong><a style='font-weight: bold;color: #2E9CC3;' href="{{$link}}">{$LINK}</a></strong> <br></div>--}}
{{--                                                            </td>--}}
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;"><br> If you have any questions, please, <a target='_blank' style='font-weight: bold;color: #2E9CC3;' href="{{$url}}">Contact Us</a>! <br></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
...
{{--                                                            <a href="{{$url}}" style="color: #333333; line-height: 20px; text-decoration: underline;">My Orders</a> |--}}
{{--                                                            <a href="{{$url}}" target="_blank" style="color: #333333; line-height: 20px; text-decoration: underline;">Specials</a> |--}}
{{--                                                            <a href="{{$url}}" style="color: #333333; line-height: 20px; text-decoration: underline;">Brands</a> |--}}
{{--                                                            <a href="{{$url}}" target="_blank" style="color: #333333; line-height: 20px; text-decoration: underline;">New Products</a>--}}
{{--                                                        </div>--}}
