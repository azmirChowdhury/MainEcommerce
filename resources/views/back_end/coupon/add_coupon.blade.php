                    ...
                    <div class="col-lg-8">
                        <div class="card m-b-20">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                {{Form::open(['method'=>'post','route'=>'save_coupon'])}}

                                <h4 class="mt-0 header-title">Add new coupon</h4>
                                <div class="form-group">
                                    <label>Coupon code <sup class="text-danger"> *</sup></label>
                                    <input type="text" name="coupon_code" value="{{old('coupon_code')}}" autocomplete="off" class="form-control"  placeholder="Coupon code"/>
                                </div>


                                <div class="form-group">
                                    <label>Coupon description</label>
                                    <textarea id="editor" name="coupon_description">{{old('coupon_description')}}</textarea>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active p-3" id="General" role="tabpanel">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="discount_amount" required value="{{old('discount_amount')}}" type="text" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label>Expire date</label>
                                                <input type="text" name="expire_date" value="{{old('expire_date')}}" class="form-control floating-label" placeholder="Date" id="date">
                                            </div>
                                        ...
                                        <div class="tab-pane p-3" id="Uses_restriction" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" name="minimum_spend" value="{{old('minimum_spend')}}" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label>maximum spend</label>
                                                <input required type="number" name="maximum_spend" value="{{old('maximum_spend')}}" class="form-control">
                                            </div>
                                            <hr>
                                        ...
                                        <div class="tab-pane p-3" id="Uses_limits" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="per_coupon" value="{{old('per_coupon')}}"  class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Uses limit per User</label>
                                                <input type="number" value="{{old('per_user')}}" name="per_user"  class="form-control">
                                            </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="form-group m-b-0 d-flex ">
                                            <a href="{{route('index_coupon')}}" type="reset" class="btn btn-secondary waves-effect m-l-30 ">
                                                Cancel
                                            </a>
